...
public Properties p;
	...
	public void setup(String os, String br) throws IOException {
		...
		if(p.getProperty("execution_evn").equalsIgnoreCase("remote")) {
			DesiredCapabilities capabilties = new DesiredCapabilities(); //DesiredCapabilities use to set Platform os(opera system) and browser
		...
		driver.get(p.getProperty("appURL2")); //reading URL from propertoes file.
